...
class _LoginRegisterState extends State<LoginRegisterPage> {
    ...
    if (validateAndSave()) {
      try {
        if (_formType == FormType.login) {
          ...
          dialogBox.information(context, "All Done",
  ...
  void moveToRegister() {
    formKey.currentState
        .reset(); //it will reloab the activity once it is closed
  ...
  Widget logo() {
    return new Hero(
      ...
      child: new CircleAvatar(
        ...
        radius: 110.0,
        child: Image.asset('images/mislinous_logo.jpg'),
      ),
    );
  }
